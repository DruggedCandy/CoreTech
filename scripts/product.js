...
function displayProductDetails(product) {
    ...
    productDetails.innerHTML = `
        <div class="col-md-6">
              <img src="${imgSrc}" class="img-fluid rounded" alt="${product.title}"
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn btn-primary-custom btn-lg" id="add-to-cart-btn" 
                                data-product='${JSON.stringify(product)}'>
                            <i class="bi bi-cart-plus"></i> Додати до кошика
                        </button>
                        <a href="products.html" class="btn btn-accent">
